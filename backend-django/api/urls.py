...
from rest_framework_simplejwt.views import TokenRefreshView, TokenObtainPairView # <-- On importe TokenObtainPairView
...
urlpatterns = [
    ...
    path("api/login/", LoginView.as_view(), name="login"), # <-- REMPLACE TON ANCIENNE LOGINVIEW PAR CELLE-CI
