    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('niveau_qualite', models.CharField(choices=[('Excellente', 'Excellente'), ('Bonne', 'Bonne'), ('Moyenne', 'Moyenne'), ('Faible', 'Faible'), ('Très faible', 'Très faible')], max_length=20)),
                ('mesure_le', models.DateTimeField(auto_now_add=True)),
                ('utilisateur', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mesures', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-mesure_le'],
            },
